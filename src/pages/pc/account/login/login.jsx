...
class Login extends Component {
    ...
    wechatLogin = () =>{
        this.setState({['wechatLogin']: !this.state.wechatLogin})
        this.setState({['randomNum']: Math.random().toString(36).substr(2)})
    }
        ...
        if(this.state.loginType){
            ...
            try {
                ...
                if(data.status === 200 || data.status === 201){
                    ...
                    this.props.saveUserInfo({username: data.username})
                        ...
                        <div className={styles['default-login-container-left-detail']}>
                            ...
                            <div className={styles['default-login-container-left-detail-content']}>
                                ...
                                <div id={styles['login_container']}>
                                    <iframe  frameBorder="0" sandbox="allow-scripts allow-same-origin allow-top-navigation"
                                    scrolling="no" src={`https://open.weixin.qq.com/connect/qrconnect?appid=wx412f53fa4a1cf3f3&redirect_uri=https://cookie.vip/account/wx_login&response_type=code&scope=snsapi_login&state=python&response_type=code&scope=snsapi_login&state=${this.state.randomNum}#wechat_redirect`}>
                                    </iframe>
                                </div> : ''}
                                {!this.state.wechatLogin ? 
                                    ...
                                    <span className={styles['other-login-method']}>其他登录方式</span>
                                        {this.state.loginType === true ? 
                                            <div className={styles['login-bottom-icon']}>
                                                ...
                                                <img className={styles['wechat-login']} onClick={this.wechatLogin.bind(this)} src={require('@/assets/account/login/wechat_login.png')} title="微信登录" alt="微信登录" />
                                            </div>
                                        :
                                            <div className={styles['login-bottom-icon']}>
