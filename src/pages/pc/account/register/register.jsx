...
class Register extends Component {
    ...
    handleRegister = async () => {
        ...
        try {
            ...
            let data = await register(phoneTypeSelcted['value'] + this.state.phone, this.state.identifyingCode, this.state.firstPassword, this.state.secondPassword, this.state.account)
            ...
            <div className={styles['register-container']}>
              ...
              <form id="register_form" className={styles['register-content']} onSubmit={this.handleSubmit.bind(this)}>
                ...
                <div className={styles['register-bottom']}>
                  <input onClick={this.handleRegister.bind(this)} type="submit" className={[`${styles['register-submit']}`,`${styles['black']}`].join(' ')} value="注册" />
