...
import {compressImage, canvasToBlob, getObjectURL} from '@/utils/commons'
import {postPicUpload, postCreate} from '@/api/getData'
import {Loading} from '@/components/common/postFormDialog/postFormDialog'
...
class PostForm extends Component {
    state = {
        ...
        coverFile: null,
        coverImage: '',
        profilePic: store.getState('forum')['forumData']['userInfo']['userInfo']['profile_pic'],
        userName: store.getState('forum')['forumData']['userInfo']['username'],
            ...
            <div className={styles.container} id="post-form">
                <div className={styles['editor-left']}>
                    <div className={styles.top}>
                        ...
                        <div className={styles.covers}>
                            ...
                            <img onClick={this.handleCoverImg.bind(this)} src={this.state.coverImage} />
                            :<span onClick={this.handleCoverImg.bind(this)}>添加封面照片</span>
                            }
                        </div>
                ...
                <div className={styles['editor-right']}>
                    <div className={styles.user}>
                        <img src={this.state.profilePic} onerror={require('@/assets/forum/none_user.png')} />
                    ...
                    <div className={styles.detail}>
                        ...
                        <button type="button" onClick={this.handlePostCreate.bind(this)} id={styles['btn-enter']}>发布</button>
                       {this.state.postError.map((item,index) => 
                        <p key={index} className={`${styles[item.status]}`} ><span />{item.text}</p>
                       )} 
                    </div>
                </div>
            </div>
